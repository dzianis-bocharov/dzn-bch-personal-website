<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $message = trim($_POST["textareaMessage"]);
        ...
        $recipient = "fewd-nyc@dzianis-bocharov.com";

        // Set the email subject.
        //$subject = "New contact from $name";
        $mySubject = trim($_POST["subject"]);
        $subject = "This is message from personal website!!! $mySubject";
