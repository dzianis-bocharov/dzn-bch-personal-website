        ...
        <div id='divSkills'>
            ...
            <div class='binSkills'>
                <div class='innerBinSkills'>
                    <h3>HTML</h3>
                    <ul>
                        <li class='liSkills'>understanding of <i class='myItalic'>Document Object Model</i>;</li>
            ...
            <div class='binSkills'>
                <div class='innerBinSkills'>
                    ...
                    <ul>
                        ...
                        <li class='liSkills'>creating of procedures for the interface of web application;</li>
                         <li class='liSkills'>making animation effects;</li>
  
                        <li class='liSkills'>using AJAX</li>
            ...
            <div class='binSkills'>
                <div class='innerBinSkills'>
                    ...
                    <ul>
                        ...
                        <li class='liSkills'>making a simple procedures for <i class='myItalic'>AJAX</i>;</li>
            ...
            <div class='binSkills'>
                <div class='innerBinSkills'>
                    ...
                    <ul>
                        ...
                        <li class='liSkills'>creating of procedures for processing data from web application</li>    
                    </ul>
                </div>
            </div>
            <div class='binSkills'>
                <div class='innerBinSkills'>
                    ...
                    <ul>
                        ...
                        <li class='liSkills'>writing procedures for inserting data to the server and retrieving them</li>
                    </ul>
                </div>
            </div>
            <div class='binSkills'>
            ...
            <div class='binSkills'>
                <div class='innerBinSkills'>
                    <h3>Drupal</h3>
                        <ul>
                            <li class='liSkills'>creating website;</li>
            ...
            <div class='binSkills'>
                <div class='innerBinSkills'>
                    <h3>Bootstrap</h3>
                    <ul>
                        <li class='liSkills'>test#1;</li>
                        <li class='liSkills'>test#2;</li>
                        <li class='liSkills'>test#3</li>
                    </ul>
                </div>
            </div>
            <div class='binSkills' class='desktopView' style='width: 50%;'>
                <div class='innerBinSkills'>
                    <h3>React</h3>
                    <ul>
                        <li class='liSkills'>test#4;</i>;</li>
                        <li class='liSkills'>test#5;</li>
                        <li class='liSkills'>test#6</li>
                    </ul>
                </div>
            </div>
            <!--ЗАКЛАДКА-->
            <div class='binSkills' id='photoshopSkills' class='desktopView' style='width: 50%;' id='fuck'>
        ...
        <div id='divAbout'>
            ...
            <div class='aboutData' id='divAboutDataProfile'>
                ...
                <div class='alignerAbout'>
                    ...
                    <br>
                    Was born 11 February 1982 in Minsk, Belarus.
                    <br>
                    3 years intensive self-learning of web technologies.
                    <br>
                    Good verbal and written communication skills.
                    <br>
                    Highly motivated, quickly learns new technologies, has ability to manage a group of people, can work in a team.
                    <br>
                    Able to use such programs and languages as HTML, CSS, JavaScript, jQuery, PHP, MySQL, Git, Drupal and Photoshop for creating contemporary websites.
                </div>
            </div>
            ...
            <div class='aboutData' id='divAboutDataExperience'>
                ...
                <div class='alignerAbout'>
                    ...
                    <br>
                    <span class='myBold'>Accurate Electric corp, New York City, USA</span>
                    <br>Electrician Foreman | September 2016 - March 2020
                    <ul>
                        <li class='liAbout'>control workers when installing electrical wiring;</li>
                        <li class='liAbout'>reading the blueprints;</li>
                        <li class='liAbout'>calculation of the required amount of materials and ordering it;</li>
                        <li class='liAbout'>installing of equipment for electric service</li>
                    </ul>
                    Electrician | February 2015 - September 2016
                    <ul>
                    ...
                    <br>
                    <span class='myBold'>United Air & Parcel, New York City, USA</span>
                    <br>
                    Warehouse Worker | March 2013 - August 2014
                    <ul>
                        <li class='liAbout'>packing of parcels;</li>
                        <li class='liAbout'>loading and unloading trucks</li>                    
                    </ul>                
                    <br>
                    <span class='myBold'>State Enterprise 'Aqua-Minsk', Minsk, Belarus</span>
                    <br>
                    Leading Economist | July 2005 - November 2012
                    <br>
                    <ul>
                    ...
                    <span class='myBold'>Unitary Enterprise "FOK Serebryanka", Minsk, Belarus</span>
                    <br>
                    Economist | September 2003 - July 2005
                    <br>
                    <ul>
        ...
        <div id='divContact'>
            ...
            <div class='binContact' id='binMessage'>
                <div class='innerBinContact' id='innerBinMessage'>
                    <div id='binNotice'><div id='noticeMessageSent'>fuck</div></div>
                    <div id='formBin'>
